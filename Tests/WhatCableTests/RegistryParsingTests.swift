...
final class RegistryParsingTests: XCTestCase {
    func testUSBCPortWatcherRecognizesPhysicalUSBCAndMagSafePorts() {
        XCTAssertTrue(USBCPortWatcher.isPhysicalPort(
        ...
        XCTAssertFalse(USBCPortWatcher.isPhysicalPort(
            serviceName: "AppleUSBHostPort@00100000",
            portTypeDescription: "USB-C"
        ))
        XCTAssertFalse(USBCPortWatcher.isPhysicalPort(
            serviceName: "Port-Internal@1",
            portTypeDescription: nil
        ))
    }
